...
* Hỗ trợ nhóm test và tích hợp toàn hệ thống.
* Hoàn thành **demo dự án nhóm**.
* Chuẩn bị **slide thuyết trình**.
* Tổng hợp và hoàn thiện các công việc cá nhân.
* Hoàn thành worklog và báo cáo cuối kỳ.
...
* Hệ thống được triển khai ổn định để phục vụ demo.
* Demo dự án nhóm thành công theo đúng kiến trúc đã thiết kế.
* Slide trình bày đầy đủ:
  - Kiến trúc hạ tầng
  - Cách deploy bằng Terraform
  - CI/CD với GitHub Actions
* Hoàn thiện toàn bộ phần việc cá nhân:
  - Cấu hình Terraform
  - Pipeline CI/CD
  - Tài liệu triển khai
* Worklog và báo cáo được nộp đầy đủ.