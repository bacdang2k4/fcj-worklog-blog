...
* Support the team in testing and integrating the entire system.
* Complete the team project demo.
* Prepare the presentation slides.
* Summarize and complete all personal tasks.
* Finish the worklog and final report.
...
* The system is deployed stably for demo.
* Successfully demoed the group project according to the designed architecture.
* Full presentation slides:
  - Infrastructure architecture
  - How to deploy with Terraform
  - CI/CD with GitHub Actions
* Completed all individual tasks:
  - Terraform configuration
  - CI/CD pipeline
  - Deployment documentation
* Worklog and report are fully submitted.